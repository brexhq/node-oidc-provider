...
const DEFAULTS = {
  ...
  features: {
    ...
    /*
     * features.disableProductionRestrictions
     *
     * title: Disable restrictions like HTTPS-only callback URIs
     *
     * description: Disables production restrictions
     */
    disableProductionRestrictions: false,
...
<body>
  ...
  /*
   * refreshTokenGracePeriodDefault
   * number of seconds a refresh token should still work after it is consumed for the first time
   */
  refreshTokenGracePeriodDefault: 0,

  /*
   * refreshTokenGracePeriod
   * map of client id -> grace period in seconds
   */
  refreshTokenGracePeriod: {},

  /*
   * refreshTokenHardDelete
   * boolean for if tokens should be hard deleted when consumed
   */
  refreshTokenHardDelete: true,
